...
#define LINE_2_SIZE_OVERFLOW        0xCF
...
class CLCD                            //class definition
{
    ...
    public:                           //public member functions prototypes
        ...
        void print(const char *s, BYTE addr);     //print the string to LCD
        void putch(char data, BYTE addr);         //print only single character at spe
};
